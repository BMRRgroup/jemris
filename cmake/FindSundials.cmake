...
IF(EXISTS ${SUNDIALS_DIR}/include/sundials/sundials_config.h)
  ...
  find_library(SUNDIALS_LIBRARIES_NVECCUDA "sundials_nveccuda" DOC "sundials libraries nveccuda")
  list(APPEND SUNDIALS_LIBRARIES ${SUNDIALS_LIBRARIES_CVODE} ${SUNDIALS_LIBRARIES_NVEC} ${SUNDIALS_LIBRARIES_NVECCUDA})
